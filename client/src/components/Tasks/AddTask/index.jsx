...
export default function AddTask({ setIsAddTask }) {
  const [lead, { addTask }] = useLead();
  ...
  const handleAddTask = () => {
    ...
    setNewTask({ ...newTask(), lead: lead._id });

    axios
      .post(`${SOLID_APP_API_SERVER}/task`, newTask(), {
  ...
  return (
    <AddTaskContainer>
      ...
      <AddTaskFooter>
        <span onClick={() => setIsAddTask(false)}>Cancel</span>
